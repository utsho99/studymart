            ...
            <div className="flex items-start justify-between gap-2">
              <div>
                <h1 className="text-lg font-bold text-gray-900 flex items-center gap-2 flex-wrap">
                  ...
                  {user.isStudentVerified && <span className="badge bg-green-50 text-green-600 border border-green-200 text-xs">✓ Student Verified</span>}
                  {user.isSenior && <span className="badge bg-purple-50 text-purple-600 border border-purple-200 text-xs">Senior</span>}
                </h1>
